                        ...
                        <div class="widgets_container contact_us">
                            ...
                            <div class="app_img">
                                <figure class="app_img">
                                    <a href="#"><img src="{{ asset("front/assets/img/icon/icon-appstore.png") }}" alt=""></a>
                                </figure>
                                <figure class="app_img">
                                    <a href="#"><img src="{{ asset("front/assets/img/icon/icon-googleplay.png") }}" alt=""></a>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="footer_contact">
                                <div class="footer_contact_inner">
                                    <div class="contact_icone">
                                        <img src="{{ asset("front/assets/img/icon/icon-phone.png") }}" alt="">
                                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="footer_payment text-right">
                            <img src="{{ asset("front/assets/img/icon/payment.png") }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
